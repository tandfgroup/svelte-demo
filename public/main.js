(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.list = factory());
  ...
  function tmpl($api, $cmp, $slotset, $ctx) {
    const {h: api_element, d: api_dynamic_text, t: api_text, b: api_bind} = $api;
    const {_m0} = $ctx;
    return [api_element("main", stc0, [api_element("img", stc1), api_element("h1", stc2, [api_text(api_dynamic_text($cmp.message))]), api_element("input", {
      props: {
        "value": $cmp.message
      },
      key: 3,
