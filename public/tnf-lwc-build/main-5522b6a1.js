import { registerTemplate, sanitizeAttribute, registerDecorators, registerComponent, LightningElement, createElement } from 'lwc';
      ...
      case 'utility':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesUtilityRtl-07bf1c71.js');
          return Lib;
        }
      ...
      case 'action':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesActionRtl-38637457.js');
          return Lib;
        }
      ...
      case 'standard':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesStandardRtl-60b2bd14.js');
          return Lib;
        }
      ...
      case 'doctype':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesDoctypeRtl-3570fc3a.js');
          return Lib;
        }
      ...
      case 'custom':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesCustomRtl-c097fe9d.js');
          return Lib;
        }
      ...
      case 'utility':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesUtility-6b0bda9b.js');
          return Lib;
        }
      ...
      case 'action':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesAction-81ffa837.js');
          return Lib;
        }
      ...
      case 'standard':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesStandard-822395c4.js');
          return Lib;
        }
      ...
      case 'doctype':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesDoctype-1a41080b.js');
          return Lib;
        }
      ...
      case 'custom':
        {
          ...
          const {
            default: Lib
          } = await import('./iconSvgTemplatesCustom-569abe80.js');
          return Lib;
        }
...
function tmpl$1($api, $cmp, $slotset, $ctx) {
  ...
  }), api_element("div", stc0$1, [api_element("p", stc1, [api_text("Selected values are: " + api_dynamic_text($cmp.selected))])])];
  /*LWC compiler v2.13.3*/
}
...
function tmpl($api, $cmp, $slotset, $ctx) {
  ...
  }, [api_text(api_dynamic_text($cmp.label))]), api_custom_element("tnf-list", _tnfList, stc0)];
  /*LWC compiler v2.13.3*/
}
