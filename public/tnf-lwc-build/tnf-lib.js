(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lwc'), require('@lwc/synthetic-shadow')) :
    typeof define === 'function' && define.amd ? define(['exports', 'lwc', '@lwc/synthetic-shadow'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["tnf-lib"] = {}, global.lwc));
    ...
    function tmpl$1($api, $cmp, $slotset, $ctx) {
      ...
      const {_m0} = $ctx;
      return [api_element("main", stc0$1, [api_element("h1", stc1$1, [api_text(api_dynamic_text($cmp.message))]), api_element("input", {
        props: {
          "value": $cmp.message
        },
        key: 2,
    ...
    var _tnfList = lwc.registerComponent(List, {
      tmpl: _tmpl$1
    ...
    (function (global, factory) {
      typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Crud = {}));
      ...
      function create_else_block_1$1(ctx) {
        ...
        return {
          ...
          p(ctx, dirty) {
            ...
            320 && button_aria_label_value !== (button_aria_label_value =
            /*ariaLabel*/
            ctx[8] ||
            /*defaultAriaLabel*/
            ctx[6])) && {
      ...
      function create_if_block$3(ctx) {
        ...
        return {
          ...
          p(ctx, dirty) {
            ...
            /*ariaLabel, defaultAriaLabel*/
            320 && a_aria_label_value !== (a_aria_label_value =
            /*ariaLabel*/
            ctx[8] ||
            /*defaultAriaLabel*/
            ctx[6])) && {
      ...
      function instance$a($$self, $$props, $$invalidate) {
        ...
        const omit_props_names = ["class", "active", "block", "children", "close", "color", "disabled", "href", "inner", "outline", "size", "style", "value", "white"];
        ...
        $$self.$$.update = () => {
          ...
          if ($$self.$$.dirty &
          /*className, close, outline, color, size, block, active, white*/
          261120) {
        ...
        return [inner, children, disabled, href, style, value, defaultAriaLabel, classes, ariaLabel, $$restProps, className, active, block, close, color, outline, size, white, $$scope, slots, click_handler, click_handler_1, a_binding, button_binding];
      }
      ...
      function instance$8($$self, $$props, $$invalidate) {
        ...
        $$self.$$.update = () => {
          if ($$self.$$.dirty &
          /*className, sm, md, lg, xl, xxl, fluid*/
          508) {
      ...
      const get_label_slot_context$1 = ctx => ({}); // (66:2) {:else}
      ...
      function create_else_block$2(ctx) {
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_2*/
              ctx[28]), listen(input, "change",
              /*change_handler_2*/
              ctx[29]), listen(input, "focus",
              /*focus_handler_2*/
              ctx[30]), listen(input, "input",
              /*input_handler_2*/
              ctx[31]), listen(input, "change",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_1*/
              ctx[24]), listen(input, "change",
              /*change_handler_1*/
              ctx[25]), listen(input, "focus",
              /*focus_handler_1*/
              ctx[26]), listen(input, "input",
              /*input_handler_1*/
              ctx[27]), listen(input, "change",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              ...
              /*change_handler*/
              ctx[21]), listen(input, "focus",
              /*focus_handler*/
              ctx[22]), listen(input, "input",
              /*input_handler*/
      ...
      function create_if_block$2(ctx) {
        ...
        /*$$scope*/
        ctx[18], get_label_slot_context$1);
        ...
        return {
          ...
          p(ctx, dirty) {
            if (label_slot) {
              if (label_slot.p && (!current || dirty[0] &
              /*$$scope*/
              262144)) {
                update_slot_base(label_slot, label_slot_template, ctx,
                /*$$scope*/
                ctx[18], !current ? get_all_dirty_from_scope(
                /*$$scope*/
                ctx[18]) : get_slot_changes(label_slot_template,
                /*$$scope*/
                ctx[18], dirty, get_label_slot_changes$1), get_label_slot_context$1);
              }
            } else {
              if (label_slot_or_fallback && label_slot_or_fallback.p && (!current || dirty[0] &
              /*label*/
              16)) {
      ...
      function create_fragment$7(ctx) {
        ...
        function select_block_type(ctx, dirty) {
          if (
          /*type*/
          ctx[6] === 'radio') return create_if_block_1$2;
          if (
          /*type*/
          ctx[6] === 'switch') return create_if_block_2$2;
      ...
      function instance$7($$self, $$props, $$invalidate) {
        ...
        let inputClasses;
        let idFor;
        const omit_props_names = ["class", "checked", "disabled", "group", "id", "inline", "inner", "invalid", "label", "name", "size", "type", "valid", "value"];
        let $$restProps = compute_rest_props($$props, omit_props_names);
        let {
          $$slots: slots = {},
          $$scope
        ...
        $$self.$$.update = () => {
          ...
          /*invalid, valid*/
          163840) {
            $$invalidate(9, inputClasses = classnames('form-check-input', {
              'is-invalid': invalid,
              'is-valid': valid
            }));
          }
        ...
        return [checked, group, inner, disabled, label, name, type, value, idFor, inputClasses, classes, $$restProps, className, id, inline, invalid, size, valid, $$scope, slots, blur_handler, change_handler, focus_handler, input_handler, blur_handler_1, change_handler_1, focus_handler_1, input_handler_1, blur_handler_2, change_handler_2, focus_handler_2, input_handler_2, input_change_handler, $$binding_groups, input_binding, input_change_handler_1, input_binding_1, input_change_handler_2, input_binding_2];
      }
      ...
      const get_label_slot_context = ctx => ({}); // (34:0) {:else}
      ...
      function create_else_block$1(ctx) {
        ...
        ctx[0] ||
        /*$$slots*/
        ctx[4].label) && create_if_block_2$1(ctx);
        let div_levels = [
        /*$$restProps*/
        ctx[3], {
          class:
      ...
      function create_if_block$1(ctx) {
        ...
        ctx[0] ||
        /*$$slots*/
        ctx[4].label) && create_if_block_1$1(ctx);
        let fieldset_levels = [
        /*$$restProps*/
        ctx[3], {
          class:
        ...
        return {
          ...
          p(ctx, dirty) {
            ...
            set_attributes(fieldset, fieldset_data = get_spread_update(fieldset_levels, [dirty &
            /*$$restProps*/
            8 &&
            /*$$restProps*/
            ctx[3], (!current || dirty &
      ...
      function create_if_block_2$1(ctx) {
        ...
        const label_slot = create_slot(label_slot_template, ctx,
        /*$$scope*/
        ctx[11], get_label_slot_context_1);
        return {
          c() {
            label_1 = element("label");
            t0 = text(
          ...
          p(ctx, dirty) {
            ...
            if (label_slot) {
              ...
              2048)) {
                ...
                ctx[11], !current ? get_all_dirty_from_scope(
                /*$$scope*/
                ctx[11]) : get_slot_changes(label_slot_template,
                /*$$scope*/
                ctx[11], dirty, get_label_slot_changes_1), get_label_slot_context_1);
              }
            }
          },
          ...
          p(ctx, dirty) {
            ...
            if (label_slot) {
              ...
              2048)) {
                ...
                ctx[11]) : get_slot_changes(label_slot_template,
                /*$$scope*/
                ctx[11], dirty, get_label_slot_changes), get_label_slot_context);
              }
            }
          },
      ...
      function instance$5($$self, $$props, $$invalidate) {
        ...
        $$self.$$.update = () => {
          if ($$self.$$.dirty &
          /*className, row, check, inline, floating, disabled*/
          2016) {
        ...
        return [label, tag, classes, $$restProps, $$slots, className, check, disabled, floating, inline, row, $$scope, slots];
      }
      ...
      function create_if_block_22(ctx) {
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(select, "blur",
              /*blur_handler_20*/
              ctx[156]), listen(select, "change",
              /*change_handler_19*/
              ctx[157]), listen(select, "focus",
              /*focus_handler_20*/
              ctx[158]), listen(select, "input",
              /*input_handler_19*/
              ctx[159]), listen(select, "change",
              /*select_change_handler*/
              ctx[207])];
              mounted = true;
            }
          ...
          p(ctx, dirty) {
            if (default_slot) {
              ...
              8388608)) {
                update_slot_base(default_slot, default_slot_template, ctx,
                /*$$scope*/
                ctx[209], !current ? get_all_dirty_from_scope(
                /*$$scope*/
                ctx[209]) : get_slot_changes(default_slot_template,
                /*$$scope*/
                ctx[209], dirty, null), null);
              }
            }

            set_attributes(select, select_data = get_spread_update(select_levels, [dirty[0] &
            /*$$restProps*/
            2097152 &&
            /*$$restProps*/
            ctx[21], (!current || dirty[0] &
            /*classes*/
            262144) && {
              class:
              /*classes*/
            ...
            if (dirty[0] &
            /*$$restProps, classes, name, disabled, readonly*/
            2400512 && 'value' in select_data) (select_data.multiple ? select_options : select_option)(select, select_data.value);
      ...
      function create_if_block_21(ctx) {
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(textarea, "blur",
              /*blur_handler_19*/
              ctx[149]), listen(textarea, "change",
              /*change_handler_18*/
              ctx[150]), listen(textarea, "focus",
              /*focus_handler_19*/
              ctx[151]), listen(textarea, "input",
              /*input_handler_18*/
              ctx[152]), listen(textarea, "keydown",
              /*keydown_handler_19*/
              ctx[153]), listen(textarea, "keypress",
              /*keypress_handler_19*/
              ctx[154]), listen(textarea, "keyup",
              /*keyup_handler_19*/
              ctx[155]), listen(textarea, "input",
          ...
          p(ctx, dirty) {
            set_attributes(textarea, textarea_data = get_spread_update(textarea_levels, [dirty[0] &
            /*$$restProps*/
            2097152 &&
            /*$$restProps*/
            ctx[21], dirty[0] &
      ...
      function create_if_block_2(ctx) {
        ...
        let if_block_anchor;
        let current;
        const if_block_creators = [create_if_block_3, create_if_block_4, create_if_block_5, create_if_block_6, create_if_block_7, create_if_block_8, create_if_block_9, create_if_block_10, create_if_block_11, create_if_block_12, create_if_block_13, create_if_block_14, create_if_block_15, create_if_block_16, create_if_block_17, create_if_block_18, create_if_block_19, create_if_block_20, create_else_block_1];
        const if_blocks = [];

        function select_block_type_1(ctx, dirty) {
          if (
          /*type*/
          ctx[16] === 'text') return 0;
          if (
          /*type*/
          ctx[16] === 'password') return 1;
          if (
          /*type*/
          ctx[16] === 'color') return 2;
          if (
          /*type*/
          ctx[16] === 'email') return 3;
          if (
          /*type*/
          ctx[16] === 'file') return 4;
          if (
          /*type*/
          ctx[16] === 'checkbox' ||
          /*type*/
          ctx[16] === 'radio' ||
          /*type*/
          ctx[16] === 'switch') return 5;
          if (
          /*type*/
          ctx[16] === 'url') return 6;
          if (
          /*type*/
          ctx[16] === 'number') return 7;
          if (
          /*type*/
          ctx[16] === 'date') return 8;
          if (
          /*type*/
          ctx[16] === 'time') return 9;
          if (
          /*type*/
          ctx[16] === 'datetime') return 10;
          if (
          /*type*/
          ctx[16] === 'datetime-local') return 11;
          if (
          /*type*/
          ctx[16] === 'month') return 12;
          if (
          /*type*/
          ctx[16] === 'color') return 13;
          if (
          /*type*/
          ctx[16] === 'range') return 14;
          if (
          /*type*/
          ctx[16] === 'search') return 15;
          if (
          /*type*/
          ctx[16] === 'tel') return 16;
          if (
          /*type*/
          ctx[16] === 'week') return 17;
          return 18;
        }
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_18*/
              ctx[144]), listen(input, "change",
              /*handleInput*/
              ctx[20]), listen(input, "focus",
              /*focus_handler_18*/
              ctx[145]), listen(input, "input",
              /*handleInput*/
              ctx[20]), listen(input, "keydown",
              /*keydown_handler_18*/
              ctx[146]), listen(input, "keypress",
              /*keypress_handler_18*/
              ctx[147]), listen(input, "keyup",
              /*keyup_handler_18*/
              ctx[148])];
              mounted = true;
            }
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_17*/
              ctx[137]), listen(input, "change",
              /*change_handler_17*/
              ctx[138]), listen(input, "focus",
              /*focus_handler_17*/
              ctx[139]), listen(input, "input",
              /*input_handler_17*/
              ctx[140]), listen(input, "keydown",
              /*keydown_handler_17*/
              ctx[141]), listen(input, "keypress",
              /*keypress_handler_17*/
              ctx[142]), listen(input, "keyup",
              /*keyup_handler_17*/
              ctx[143]), listen(input, "input",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_16*/
              ctx[130]), listen(input, "change",
              /*change_handler_16*/
              ctx[131]), listen(input, "focus",
              /*focus_handler_16*/
              ctx[132]), listen(input, "input",
              /*input_handler_16*/
              ctx[133]), listen(input, "keydown",
              /*keydown_handler_16*/
              ctx[134]), listen(input, "keypress",
              /*keypress_handler_16*/
              ctx[135]), listen(input, "keyup",
              /*keyup_handler_16*/
              ctx[136]), listen(input, "input",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_15*/
              ctx[123]), listen(input, "change",
              /*change_handler_15*/
              ctx[124]), listen(input, "focus",
              /*focus_handler_15*/
              ctx[125]), listen(input, "input",
              /*input_handler_15*/
              ctx[126]), listen(input, "keydown",
              /*keydown_handler_15*/
              ctx[127]), listen(input, "keypress",
              /*keypress_handler_15*/
              ctx[128]), listen(input, "keyup",
              /*keyup_handler_15*/
              ctx[129]), listen(input, "input",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_14*/
              ctx[116]), listen(input, "change",
              /*change_handler_14*/
              ctx[117]), listen(input, "focus",
              /*focus_handler_14*/
              ctx[118]), listen(input, "input",
              /*input_handler_14*/
              ctx[119]), listen(input, "keydown",
              /*keydown_handler_14*/
              ctx[120]), listen(input, "keypress",
              /*keypress_handler_14*/
              ctx[121]), listen(input, "keyup",
              /*keyup_handler_14*/
              ctx[122]), listen(input, "change",
              /*input_change_input_handler*/
              ctx[197]), listen(input, "input",
              /*input_change_input_handler*/
              ctx[197])];
              mounted = true;
            }
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_13*/
              ctx[109]), listen(input, "change",
              /*change_handler_13*/
              ctx[110]), listen(input, "focus",
              /*focus_handler_13*/
              ctx[111]), listen(input, "input",
              /*input_handler_13*/
              ctx[112]), listen(input, "keydown",
              /*keydown_handler_13*/
              ctx[113]), listen(input, "keypress",
              /*keypress_handler_13*/
              ctx[114]), listen(input, "keyup",
              /*keyup_handler_13*/
              ctx[115]), listen(input, "input",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_12*/
              ctx[102]), listen(input, "change",
              /*change_handler_12*/
              ctx[103]), listen(input, "focus",
              /*focus_handler_12*/
              ctx[104]), listen(input, "input",
              /*input_handler_12*/
              ctx[105]), listen(input, "keydown",
              /*keydown_handler_12*/
              ctx[106]), listen(input, "keypress",
              /*keypress_handler_12*/
              ctx[107]), listen(input, "keyup",
              /*keyup_handler_12*/
              ctx[108]), listen(input, "input",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_11*/
              ctx[95]), listen(input, "change",
              /*change_handler_11*/
              ctx[96]), listen(input, "focus",
              /*focus_handler_11*/
              ctx[97]), listen(input, "input",
              /*input_handler_11*/
              ctx[98]), listen(input, "keydown",
              /*keydown_handler_11*/
              ctx[99]), listen(input, "keypress",
              /*keypress_handler_11*/
              ctx[100]), listen(input, "keyup",
              /*keyup_handler_11*/
              ctx[101]), listen(input, "input",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_10*/
              ctx[88]), listen(input, "change",
              /*change_handler_10*/
              ctx[89]), listen(input, "focus",
              /*focus_handler_10*/
              ctx[90]), listen(input, "input",
              /*input_handler_10*/
              ctx[91]), listen(input, "keydown",
              /*keydown_handler_10*/
              ctx[92]), listen(input, "keypress",
              /*keypress_handler_10*/
              ctx[93]), listen(input, "keyup",
              /*keyup_handler_10*/
              ctx[94]), listen(input, "input",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_9*/
              ctx[81]), listen(input, "change",
              /*change_handler_9*/
              ctx[82]), listen(input, "focus",
              /*focus_handler_9*/
              ctx[83]), listen(input, "input",
              /*input_handler_9*/
              ctx[84]), listen(input, "keydown",
              /*keydown_handler_9*/
              ctx[85]), listen(input, "keypress",
              /*keypress_handler_9*/
              ctx[86]), listen(input, "keyup",
              /*keyup_handler_9*/
              ctx[87]), listen(input, "input",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_8*/
              ctx[74]), listen(input, "change",
              /*change_handler_8*/
              ctx[75]), listen(input, "focus",
              /*focus_handler_8*/
              ctx[76]), listen(input, "input",
              /*input_handler_8*/
              ctx[77]), listen(input, "keydown",
              /*keydown_handler_8*/
              ctx[78]), listen(input, "keypress",
              /*keypress_handler_8*/
              ctx[79]), listen(input, "keyup",
              /*keyup_handler_8*/
              ctx[80]), listen(input, "input",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_7*/
              ctx[67]), listen(input, "change",
              /*change_handler_7*/
              ctx[68]), listen(input, "focus",
              /*focus_handler_7*/
              ctx[69]), listen(input, "input",
              /*input_handler_7*/
              ctx[70]), listen(input, "keydown",
              /*keydown_handler_7*/
              ctx[71]), listen(input, "keypress",
              /*keypress_handler_7*/
              ctx[72]), listen(input, "keyup",
              /*keyup_handler_7*/
              ctx[73]), listen(input, "input",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_6*/
              ctx[60]), listen(input, "change",
              /*change_handler_6*/
              ctx[61]), listen(input, "focus",
              /*focus_handler_6*/
              ctx[62]), listen(input, "input",
              /*input_handler_6*/
              ctx[63]), listen(input, "keydown",
              /*keydown_handler_6*/
              ctx[64]), listen(input, "keypress",
              /*keypress_handler_6*/
              ctx[65]), listen(input, "keyup",
              /*keyup_handler_6*/
              ctx[66]), listen(input, "input",
      ...
      function create_if_block_8(ctx) {
        ...
        /*value*/
        ctx[6] !== void 0) {
          formcheck_props.value =
          /*value*/
          ctx[6];
        }

        formcheck = new FormCheck({
          props: formcheck_props
        });
        ...
        /*input_handler_5*/
        ctx[177]);
        formcheck.$on("keydown",
        /*keydown_handler_5*/
        ctx[178]);
        formcheck.$on("keypress",
        /*keypress_handler_5*/
        ctx[179]);
        formcheck.$on("keyup",
        /*keyup_handler_5*/
        ...
        return {
          ...
          p(ctx, dirty) {
            const formcheck_changes = dirty[0] &
            /*$$restProps, className, bsSize, type, disabled, invalid, label, name, placeholder, readonly, valid*/
            2354561 ? get_spread_update(formcheck_spread_levels, [dirty[0] &
            /*$$restProps*/
            ...
            4) {
              ...
              formcheck_changes.checked =
              /*checked*/
              ctx[2];
              add_flush_callback(() => updating_checked = false);
            }

            if (!updating_inner && dirty[0] &
            /*inner*/
            32) {
              updating_inner = true;
              formcheck_changes.inner =
              /*inner*/
              ctx[5];
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_4*/
              ctx[53]), listen(input, "change",
              /*change_handler_4*/
              ctx[54]), listen(input, "focus",
              /*focus_handler_4*/
              ctx[55]), listen(input, "input",
              /*input_handler_4*/
              ctx[56]), listen(input, "keydown",
              /*keydown_handler_4*/
              ctx[57]), listen(input, "keypress",
              /*keypress_handler_4*/
              ctx[58]), listen(input, "keyup",
              /*keyup_handler_4*/
              ctx[59]), listen(input, "change",
              /*input_change_handler*/
              ctx[168])];
              mounted = true;
            }
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_3*/
              ctx[46]), listen(input, "change",
              /*change_handler_3*/
              ctx[47]), listen(input, "focus",
              /*focus_handler_3*/
              ctx[48]), listen(input, "input",
              /*input_handler_3*/
              ctx[49]), listen(input, "keydown",
              /*keydown_handler_3*/
              ctx[50]), listen(input, "keypress",
              /*keypress_handler_3*/
              ctx[51]), listen(input, "keyup",
              /*keyup_handler_3*/
              ctx[52]), listen(input, "input",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_2*/
              ctx[39]), listen(input, "change",
              /*change_handler_2*/
              ctx[40]), listen(input, "focus",
              /*focus_handler_2*/
              ctx[41]), listen(input, "input",
              /*input_handler_2*/
              ctx[42]), listen(input, "keydown",
              /*keydown_handler_2*/
              ctx[43]), listen(input, "keypress",
              /*keypress_handler_2*/
              ctx[44]), listen(input, "keyup",
              /*keyup_handler_2*/
              ctx[45]), listen(input, "input",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              dispose = [listen(input, "blur",
              /*blur_handler_1*/
              ctx[32]), listen(input, "change",
              /*change_handler_1*/
              ctx[33]), listen(input, "focus",
              /*focus_handler_1*/
              ctx[34]), listen(input, "input",
              /*input_handler_1*/
              ctx[35]), listen(input, "keydown",
              /*keydown_handler_1*/
              ctx[36]), listen(input, "keypress",
              /*keypress_handler_1*/
              ctx[37]), listen(input, "keyup",
              /*keyup_handler_1*/
              ctx[38]), listen(input, "input",
        ...
        return {
          ...
          m(target, anchor) {
            ...
            if (!mounted) {
              ...
              /*change_handler*/
              ctx[26]), listen(input, "focus",
              /*focus_handler*/
              ctx[27]), listen(input, "input",
              /*input_handler*/
              ctx[28]), listen(input, "keydown",
              /*keydown_handler*/
              ctx[29]), listen(input, "keypress",
              /*keypress_handler*/
              ctx[30]), listen(input, "keyup",
              /*keyup_handler*/
              ctx[31]), listen(input, "input",
              /*input_input_handler*/
              ctx[160])];
              mounted = true;
            }
      ...
      function create_else_block(ctx) {
        ...
        return {
          ...
          p(ctx, dirty) {
            ...
            if (dirty[0] &
            /*valid*/
            131072) formfeedback_changes.valid =
            /*valid*/
            ctx[17];
      ...
      function create_fragment$4(ctx) {
        ...
        function select_block_type(ctx, dirty) {
          if (
          /*tag*/
          ctx[19] === 'input') return 0;
          if (
          /*tag*/
          ctx[19] === 'textarea') return 1;
          if (
          /*tag*/
          ctx[19] === 'select' && !
          /*multiple*/
      ...
      function instance$4($$self, $$props, $$invalidate) {
        const omit_props_names = ["class", "bsSize", "checked", "color", "disabled", "feedback", "files", "group", "inner", "invalid", "label", "multiple", "name", "placeholder", "plaintext", "readonly", "size", "type", "valid", "value"];
        let $$restProps = compute_rest_props($$props, omit_props_names);
        let {
          $$slots: slots = {},
          $$scope
        ...
        $$self.$$.update = () => {
          if ($$self.$$.dirty[0] &
          /*type, color, plaintext, size, className, invalid, valid, bsSize*/
          12780675) {
            {
        ...
        return [bsSize, size, checked, files, group, inner, value, className, disabled, feedback, invalid, label, multiple, name, placeholder, readonly, type, valid, classes, tag, handleInput, $$restProps, color, plaintext, slots, blur_handler, change_handler, focus_handler, input_handler, keydown_handler, keypress_handler, keyup_handler, blur_handler_1, change_handler_1, focus_handler_1, input_handler_1, keydown_handler_1, keypress_handler_1, keyup_handler_1, blur_handler_2, change_handler_2, focus_handler_2, input_handler_2, keydown_handler_2, keypress_handler_2, keyup_handler_2, blur_handler_3, change_handler_3, focus_handler_3, input_handler_3, keydown_handler_3, keypress_handler_3, keyup_handler_3, blur_handler_4, change_handler_4, focus_handler_4, input_handler_4, keydown_handler_4, keypress_handler_4, keyup_handler_4, blur_handler_6, change_handler_6, focus_handler_6, input_handler_6, keydown_handler_6, keypress_handler_6, keyup_handler_6, blur_handler_7, change_handler_7, focus_handler_7, input_handler_7, keydown_handler_7, keypress_handler_7, keyup_handler_7, blur_handler_8, change_handler_8, focus_handler_8, input_handler_8, keydown_handler_8, keypress_handler_8, keyup_handler_8, blur_handler_9, change_handler_9, focus_handler_9, input_handler_9, keydown_handler_9, keypress_handler_9, keyup_handler_9, blur_handler_10, change_handler_10, focus_handler_10, input_handler_10, keydown_handler_10, keypress_handler_10, keyup_handler_10, blur_handler_11, change_handler_11, focus_handler_11, input_handler_11, keydown_handler_11, keypress_handler_11, keyup_handler_11, blur_handler_12, change_handler_12, focus_handler_12, input_handler_12, keydown_handler_12, keypress_handler_12, keyup_handler_12, blur_handler_13, change_handler_13, focus_handler_13, input_handler_13, keydown_handler_13, keypress_handler_13, keyup_handler_13, blur_handler_14, change_handler_14, focus_handler_14, input_handler_14, keydown_handler_14, keypress_handler_14, keyup_handler_14, blur_handler_15, change_handler_15, focus_handler_15, input_handler_15, keydown_handler_15, keypress_handler_15, keyup_handler_15, blur_handler_16, change_handler_16, focus_handler_16, input_handler_16, keydown_handler_16, keypress_handler_16, keyup_handler_16, blur_handler_17, change_handler_17, focus_handler_17, input_handler_17, keydown_handler_17, keypress_handler_17, keyup_handler_17, blur_handler_18, focus_handler_18, keydown_handler_18, keypress_handler_18, keyup_handler_18, blur_handler_19, change_handler_18, focus_handler_19, input_handler_18, keydown_handler_19, keypress_handler_19, keyup_handler_19, blur_handler_20, change_handler_19, focus_handler_20, input_handler_19, input_input_handler, input_binding, input_input_handler_1, input_binding_1, input_input_handler_2, input_binding_2, input_input_handler_3, input_binding_3, input_change_handler, input_binding_4, formcheck_checked_binding, formcheck_inner_binding, formcheck_group_binding, formcheck_value_binding, blur_handler_5, change_handler_5, focus_handler_5, input_handler_5, keydown_handler_5, keypress_handler_5, keyup_handler_5, input_input_handler_4, input_binding_5, input_input_handler_5, input_binding_6, input_input_handler_6, input_binding_7, input_input_handler_7, input_binding_8, input_input_handler_8, input_binding_9, input_input_handler_9, input_binding_10, input_input_handler_10, input_binding_11, input_input_handler_11, input_binding_12, input_change_input_handler, input_binding_13, input_input_handler_12, input_binding_14, input_input_handler_13, input_binding_15, input_input_handler_14, input_binding_16, textarea_input_handler, textarea_binding, select_change_handler, select_binding, $$scope];
      }
      ...
      function create_fragment$3(ctx) {
        ...
        return {
          ...
          p(ctx, [dirty]) {
            ...
            set_attributes(label, label_data = get_spread_update(label_levels, [dirty &
            /*$$restProps*/
            4 &&
            /*$$restProps*/
            ctx[2], (!current || dirty &
      ...
      function instance$3($$self, $$props, $$invalidate) {
        ...
        $$props = exclude_internal_props($$props);
        return [fore, classes, $$restProps, className, hidden, check, size, xs, sm, md, lg, xl, xxl, widths, $$scope, slots];
      }
      ...
      function instance$2($$self, $$props, $$invalidate) {
        ...
        $$self.$$.update = () => {
          if ($$self.$$.dirty &
          /*className, noGutters, form, cols*/
          120) {
            $$invalidate(1, classes = classnames(className, noGutters ? 'gx-0' : null, form ? 'form-row' : 'row', ...getCols(cols)));
          }
        };

        return [inner, classes, $$restProps, className, noGutters, form, cols, $$scope, slots, div_binding];
      }
      ...
      function instance$1($$self, $$props, $$invalidate) {
        ...
        return [first, last, selected, el, buttonClicked, slots, click_handler, click_handler_1, click_handler_2, div_binding, $$scope];
      }
      ...
      function create_default_slot_5(ctx) {
        ...
        return {
          ...
          p(ctx, dirty) {
            ...
            if (dirty &
            /*$$scope, filteredPeople, radioGroup*/
            1048581) {
              formgroup_changes.$$scope = {
                dirty,
                ctx
      ...
      function create_default_slot_2(ctx) {
        ...
        return {
          ...
          p(ctx, dirty) {
            ...
            if (dirty &
            /*first*/
            16) crudbuttons_changes.first =
            /*first*/
            ctx[4];
            if (dirty &
            /*last*/
            32) crudbuttons_changes.last =
            /*last*/
            ctx[5];
            if (dirty &
            /*selected*/
            8) crudbuttons_changes.selected =
            /*selected*/
            ctx[3];
      ...
      function create_fragment(ctx) {
        ...
        return {
          ...
          p(ctx, [dirty]) {
            ...
            if (dirty &
            /*$$scope, first, last, selected, filteredPeople, radioGroup, prefix*/
            1048639) {
      ...
      function instance($$self, $$props, $$invalidate) {
        ...
        function create() {
          $$invalidate(8, people = people.concat({
            first,
            last
          }));
        ...
        $$self.$$.update = () => {
          ...
          /*prefix, people*/
          258) {
            $$invalidate(2, filteredPeople = prefix ? people.filter(person => {
        ...
        return [radioGroup, prefix, filteredPeople, selected, first, last, i, buttonClicked, people, input_value_binding, input_value_binding_1, input_value_binding_2, input_group_binding, buttonClicked_handler];
      }
    ...
    var button = lwc.registerComponent(Button, {
      tmpl: _tmpl
